...
const passos = [
  ...
  },
  {
    ...
    desc: 'Cadastre seus pacientes e crie lembretes para não esquecer nenhuma pendência durante o plantão. O app avisa no horário certo, mesmo com a tela fechada. No dashboard, um botão vermelho mostra quantas pendências estão abertas.'
  },
  {
    icone: '✏️',
  ...
  },
  {
    ...
    desc: 'Qualquer dúvida, o botão Ajuda está no cabeçalho do painel. Seus dados ficam salvos automaticamente — mesmo sem internet.'
  }
]
