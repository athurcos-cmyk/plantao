...
> Guia de prompts para geração de imagens de divulgação.
> Atualizado: 2026-04-30

## Stack de imagem

- **Ferramenta:** ChatGPT com geração de imagem (DALL-E)
- **Formato:** Quadrado 1:1 (Instagram, Facebook, WhatsApp)
- **Estilo:** Foto realista de campanha publicitária profissional
- **Paleta:** Azul escuro (#0A1628), azul (#1E88E5), tons frios hospitalares

## Identidade visual do perfil — consistência obrigatória

Todas as imagens devem seguir o mesmo DNA visual. O feed precisa parecer de uma marca, não de uma pasta de downloads.

**O que NÃO muda entre as imagens:**
- **Tom de luz:** frio, profissional, hospitalar (nada de luz amarela quente ou sunset filter)
- **Paleta dominante:** azul escuro (#0A1628), azul (#1E88E5), branco/gelo para texto
- **Estilo de foto:** foto realista de campanha — nada de ilustração 2D, vetor, cartoon ou 3D
- **ícone do Plantão:** sempre no canto inferior direito, sempre o mesmo arquivo, sem alterar cor
- **Fontes dos textos:** limpas, modernas, sem serifa — nunca usar fontes decorativas ou cursivas
- **Uniforme:** azul escuro ou branco, padrão hospitalar brasileiro — nunca jaleco social ou roupa civil

**O que pode variar:**
- O personagem (enfermeiro, enfermeira, técnica, técnico — variar gênero e idade)
- O ambiente (posto, corredor, leito, enfermaria)
- O problema retratado (PC ocupado, papel perdido, internet caiu, pendência esquecida)

**O que NÃO pode ter em hipótese alguma:**
- Ilustração estilo vetor ou cartoon
- Cores pasteis, vibrantes demais ou neon
- Fundo genérico de banco de imagens (gente branca sorrindo em escritório)
- Emojis na imagem (emojis só na legenda)
- Foto com celular mostrando tela borrada — a tela precisa ser legível

## Regras gerais dos prompts

1. **Sempre pedir para usar o ícone enviado** — "Use o ícone que vou enviar como anexo, posicione no canto inferior direito sem alterar suas cores ou formato"
2. **Não descrever o logo no prompt** — o ChatGPT usa a imagem anexada
3. **Texto na imagem** — o ChatGPT atual consegue texto limpo, mas sempre revisar se não tem erro de português
...
# 50 Prompts completos

---

## 📱 INSTAGRAM FEED — DOR DIRETA (1-12)

> Problemas reais do plantão que toda enfermeira reconhece.

---

### 1. PC ocupado de novo?
...
### 5. Letra de enfermeiro ninguém merece
...
### 7. Três folhas de evolução e sumiu
**Canais:** Instagram feed
...
### 10. O bolso do jaleco não é arquivo
**Canais:** Instagram feed / Facebook
...
### 11. Cada enfermeiro já perdeu um papel
**Canais:** Instagram feed
...
## 📱 INSTAGRAM FEED — BENEFÍCIO DIRETO (13-24)

> O que o Plantão resolve e por que baixar.

---

### 13. Anota no celular. Cola no sistema.
**Canais:** Instagram feed / Facebook
...
### 14. 3 coisas que você não precisa mais
...
**Legenda:**
> Enquanto você escreve no papel, o Plantão já formatou. ⚡
>
...
### 17. Modelos que salvam seu tempo
**Canais:** Instagram feed
...
## 📱 INSTAGRAM FEED — VIBE/EMOCIONAL (25-33)

> Conexão emocional com a profissão.

---

### 25. Você cuida, o Plantão anota
**Canais:** Instagram feed
...
### 26. Enfermagem não é burocracia
**Canais:** Instagram feed
...
### 29. A tecnologia a serviço do cuidado
**Canais:** Instagram feed / Facebook
...
### 33. Seu bolso merecia um descanso
**Canais:** Instagram feed
...
## 📱 INSTAGRAM FEED — PROVA SOCIAL (34-38)

> Mostrar que outras enfermeiras já usam e aprovam.

---

### 34. Já são mais de 100 enfermeiros
**Canais:** Instagram feed / Facebook
...
### 37. Aos poucos o papel vai ficando
**Canais:** Instagram feed
...
### 38. Todo mundo merece um app assim
**Canais:** Instagram feed / WhatsApp
...
## 📱 INSTAGRAM FEED — HUMOR/ENGAJAMENTO (39-43)

> Posts leves para aumentar engajamento e compartilhamentos.

---

### 39. PC ocupado é parente do que nunca volta
**Canais:** Instagram feed / Story
...
### 41. O terceiro turno é o mais difícil
**Canais:** Instagram feed
...
### 42. Enfermagem: multitarefa nível hard
**Canais:** Instagram feed / Facebook
...
### 43. Salva esse post pra não esquecer
**Canais:** Instagram feed / Story
...
> Conteúdo em múltiplos slides para feed do Instagram.

---

### 44. Carrossel — Como funciona em 3 passos
**Canais:** Instagram Carrossel (3 slides)

**Prompt pra cada slide:**

**Slide 1 (Capa):**
> Crie uma imagem quadrada 1:1 com fundo azul escuro, texto centralizado "COMO FUNCIONA O PLANTÃO" em branco. Abaixo: "3 passos • 1 minuto • Gratuito" em azul. Use o ícone anexado no canto inferior direito.
...
### 45. Carrossel — 5 motivos pra largar o papel
**Canais:** Instagram Carrossel (4 slides)

**Prompts:**

**Slide 1 (Capa):**
> Crie uma imagem quadrada 1:1 com fundo azul escuro, texto centralizado "5 MOTIVOS PRA LARGAR O PAPEL NO PLANTÃO" em branco. Use o ícone anexado.

**Slide 2:**
> Crie uma imagem quadrada 1:1 com fundo azul escuro. "1 — Molha" em grande. Abaixo, ícone de água + "Álcool, soro, café... o papel não resiste." em branco.

**Slide 3:**
> Crie uma imagem quadrada 1:1 com fundo azul escuro. "2 — Perde" em grande. Abaixo, ícone de ? + "Já perdeu um papel no meio do plantão? No celular não." em branco.

**Slide 4:**
> Crie uma imagem quadrada 1:1 com fundo azul escuro. "3 — Amassa" em grande. Abaixo, ícone de papel amassado + "Bolso do jaleco não é arquivo." Embaixo: "Veja os outros 2 motivos no nosso perfil!" em branco. Use o ícone anexado.

**Legenda do carrossel:**
> 5 motivos pra largar o papel no plantão 📄➡️📱
>
> 1️⃣ Molha
> 2️⃣ Perde
> 3️⃣ Amassa
...
### 47. Carrossel — Tour rápido pelo app
**Canais:** Instagram Carrossel (4 slides)

**Prompts:**

**Slide 1 (Capa):**
> Crie uma imagem quadrada 1:1 com fundo azul escuro, texto "TOUR RÁPIDO PELO PLANTÃO" em branco. Abaixo: "O app que organiza seu plantão • 30 segundos" em azul. Use o ícone anexado.

**Slide 2:**
> Crie uma imagem quadrada 1:1 com fundo azul escuro. Ícone de texto + "Anotações prontas em segundos. Escolha o tipo, preencha, copie."
...
## 📸 INSTAGRAM STORIES (48-50)

> Conteúdo vertical 9:16 para Stories. Cada story é uma imagem única com CTA rápido.

---

### 48. Story — Direto ao ponto
...
- [ ] O ChatGPT usou o ícone que enviei ou inventou um?
- [ ] Texto na imagem tem erro de português?
- [ ] A cor do ícone foi alterada?
- [ ] A cena passa a mensagem certa sozinha (sem precisar de legenda)?
- [ ] A imagem funciona em miniatura (pré-visualização do WhatsApp)?
- [ ] A proporção está correta (1:1 ou 9:16)?
- [ ] A legenda tem gancho nos primeiros 2 segundos?
...
### 1. PC ocupado de novo?
**Canais:** Facebook / WhatsApp / Instagram feed

**Imagem:**
> Crie uma imagem realista para post no Instagram (formato quadrado 1:1) de um técnico ou técnica de enfermagem em uniforme hospitalar, segurando um celular com as duas mãos, olhando para a tela com expressão aliviada. Ao fundo, visível, um computador de hospital (estilo carrinho ou suporte de parede) com a tela congelada/travada — mas ela não está nem olhando para ele, está resolvida no celular. O ambiente é um corredor ou posto de enfermagem com iluminação fria e profissional. O clima é de alívio — ela tem o que precisa na mão. Na imagem, inclua os textos: título grande no topo "PC ocupado de novo?" em letras brancas e grossas; abaixo "Suas anotações de enfermagem no celular. Funciona sem internet." em letras menores; três bullets no canto inferior esquerdo: "✓ Texto pronto pra copiar  ✓ Pendências com notificação  ✓ Zero papel perdido". Use o ícone que vou enviar como anexo e posicione no canto inferior direito sem alterar suas cores ou formato. Estilo foto realista de campanha publicitária hospitalar.
...
**Imagem:**
> Crie uma imagem realista de uma técnica de enfermagem segurando um celular em um corredor de hospital com iluminação fria. Ela está sorrindo, resolvida. Ao fundo, levemente desfocado, um aviso ou placa escrito "Sem sinal" ou um roteador com um X vermelho — mas ela não se importa, está usando o celular tranquilamente. O ambiente tem iluminação hospitalar fria, uniforme azul escuro. Estilo foto realista profissional. Texto grande na imagem, no topo: "Caiu a internet? Nem percebi." em letras brancas. Texto menor abaixo: "O Plantão funciona offline. Anota no celular, sincroniza quando voltar." Use o ícone que vou enviar como anexo no canto inferior direito sem alterar suas cores ou formato.
...
> Aquela pendência das 6h que você lembrou às 18h. 😰
>
> Todo enfermeiro conhece esse momento. A pendência que ficou pra trás no meio do caos do plantão.
>
> Com o Plantão você cria pendências com notificação programada. Na hora certa, seu celular avisa. Não depende da sua memória.
>
> 📲 plantao.net
...
### 4. Três coisas que você não precisa mais
**Canais:** Instagram feed / Facebook / Carrossel

**Imagem:**
> Crie uma imagem limpa e conceitual para post no Instagram (formato quadrado 1:1). Uma mesa de hospital com três objetos: (1) um bloco de papel amassado, (2) uma caneta quebrada, (3) um computador com tela azul de erro. Todos com aspecto de "não servem mais". Ao lado, um celular moderno brilhando com a tela limpa e organizada. Iluminação fria, fundo escuro. Texto grande na imagem: "3 coisas que você não precisa mais no plantão." e abaixo: "Papel • Caneta • PC ocupado". Estilo foto realista editorial. Use o ícone que vou enviar como anexo no canto inferior direito.
...
### 6. Seu plantão no controle (vibe)
**Canais:** Instagram feed
...
### 7. Anota no celular. Cola no sistema.
**Canais:** Instagram feed / Facebook
...
### 9. O bolso do jaleco não é arquivo
**Canais:** Instagram feed / Facebook

**Imagem:**
> Crie uma imagem realista e bem iluminada de um jaleco de enfermagem pendurado. Do bolso do jaleco, vários papéis amassados e dobrados estão saindo, quase caindo. Ao lado, uma mão segura um celular com a tela limpa. O contraste é claro: papéis bagunçados vs. celular organizado. Iluminação fria hospitalar, fundo neutro. Texto na imagem, grande no topo: "O bolso do jaleco não é arquivo." em letras brancas. Abaixo: "Seus registros no celular. Sem papel amassado." Use o ícone que vou enviar como anexo no canto inferior direito sem alterar suas cores ou formato. Estilo foto realista.
...
### 10. Cada enfermeiro já perdeu um papel no plantão
**Canais:** Instagram feed (engajamento)

**Imagem:**
> Crie uma imagem realista de close-up de uma mão de enfermeiro segurando um papel amassado e manchado (simulando água ou suor), com aspecto de "não serve mais". O papel está ilegível. A outra mão segura um celular com tela limpa e brilhante. Iluminação dramática: fundo escuro, luz destacando as mãos. Texto na imagem: "Cada enfermeiro já perdeu um papel no plantão." em letras brancas. Abaixo: "O Plantão resolve." Use o ícone que vou enviar como anexo no canto inferior direito. Estilo foto realista, tons frios.
...
### 14. WhatsApp — direto pro grupo da enfermagem
...
### 15. WhatsApp — grupo da faculdade/equipe
**Canal:** WhatsApp (imagem compartilhável)
...
## 🎡 BÔNUS: Instagram Carrrossel

### 16. Carrossel — Como funciona em 3 passos (bônus)
**Canal:** Instagram Carrossel (3 imagens)

**Prompt pra cada slide:**

**Slide 1 (Capa):**
> Crie uma imagem quadrada 1:1 com fundo azul escuro #0A1628, texto grande centralizado "COMO FUNCIONA O PLANTÃO" em branco. Abaixo: "3 passos • 1 minuto • Gratuito" em azul #1E88E5. Elegante, limpo, profissional. Use o ícone que vou enviar como anexo no canto inferior direito.

**Slide 2 (Passo a passo):**
> Crie uma imagem quadrada 1:1 com fundo azul escuro #0A1628. Três cards ou etapas visuais na vertical:
> 1. Ícone de celular + texto "Anota durante o plantão"
> 2. Ícone de nuvem + texto "Sincroniza automático"
> 3. Ícone de computador + texto "Copia pro sistema"
...
- [ ] Tem CTA claro (link, comentar, compartilhar)?

## Sessões futuras

Se for criar uma nova imagem de divulgação, seguir este guia e adicionar o prompt usado aqui no final.
